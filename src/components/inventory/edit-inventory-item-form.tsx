...
export function EditInventoryItemForm({ item, onItemUpdated, isOpen, setIsOpen }: EditInventoryItemFormProps) {
  ...
  function onSubmit(values: InventoryItem) {
    ...
    toast({
      title: "Başarılı!",
      description: `${values.name} envanteri başarıyla güncellendi.`,
    });
    setIsOpen(false);
  }
